...
import com.margub.truecaller.model.Account;
import com.margub.truecaller.model.Business;
import com.margub.truecaller.model.User;
import com.margub.truecaller.model.common.BusinessSize;
...
public class TrueCallerApplication {
    public static void main(String[] args) throws ContactsExceedException, BlockLimitExceededException {
        Account account1 = new User();
        account1.register(UserCategory.FREE, "u1", "pwd", "u1@email.com",
                "6822333", "+91", "u1");
        ...
        System.out.println("------------------------------------------");
        System.out.println(GlobalContacts.INSTANCE.getContactTrie().longestCommonPrefix());
